...
export const STRINGS = {
  ...
  home_meta_title: {
    he: 'אזעקות בזמן אמת — מפת צבע אדום והתרעות פיקוד העורף | אזעקה',
    en: 'Red Alert map — live Home Front Command alerts in real time | Azaka',
    ar: 'خريطة الإنذارات المباشرة — تنبيهات قيادة الجبهة الداخلية في الوقت الفعلي | أزاكا',
    ru: 'Карта тревог в реальном времени — оповещения Командования тыла | Azaka',
  },
  home_meta_desc: {
    he: 'מפה חיה של אזעקות צבע אדום והתרעות פיקוד העורף בזמן אמת: אילו אזורים מותקפים עכשיו, התרעות מקדימות, זמן כניסה למרחב מוגן והנחיות התגוננות רשמיות. בעברית, English, العربية, русский.',
    en: 'A live map of Red Alerts and Home Front Command warnings in real time: which areas are under attack now, early warnings, shelter-entry time, and official protection guidance. In Hebrew, English, Arabic, and Russian.',
    ar: 'خريطة مباشرة لإنذارات اللون الأحمر وتنبيهات قيادة الجبهة الداخلية في الوقت الفعلي: المناطق المستهدفة الآن، التنبيهات المبكرة، زمن الدخول إلى المساحة المحمية وإرشادات الحماية الرسمية. بالعبرية والإنجليزية والعربية والروسية.',
    ru: 'Живая карта тревог «Цева адом» и оповещений Командования тыла в реальном времени: какие районы атакованы сейчас, ранние предупреждения, время входа в укрытие и официальные инструкции по защите. На иврите, английском, арабском и русском.',
  },
  hist_meta_title: {
    he: 'סטטיסטיקה היסטורית של התרעות פיקוד העורף | אזעקה',
    en: 'Historical Home Front Command alert statistics | Azaka',
    ar: 'إحصائيات تاريخية لتنبيهات قيادة الجبهة الداخلية | أزاكا',
    ru: 'Историческая статистика оповещений Командования тыла | Azaka',
  },
  hist_meta_desc: {
    he: 'סטטיסטיקה היסטורית של אזעקות צבע אדום: התפלגות לפי חודש, סוג איום ויישוב, מבוססת על לוג ההתרעות של פיקוד העורף.',
    en: 'Historical Red-Alert statistics: distribution by month, threat type, and locality, based on the Home Front Command alert log.',
    ar: 'إحصائيات تاريخية لإنذارات اللون الأحمر: التوزيع حسب الشهر ونوع التهديد والمنطقة، استنادًا إلى سجل تنبيهات قيادة الجبهة الداخلية.',
    ru: 'Историческая статистика тревог «Цева адом»: распределение по месяцам, типам угроз и населённым пунктам по журналу оповещений Командования тыла.',
  },
  notfound_title: { he: 'הדף לא נמצא', en: 'Page not found', ar: 'الصفحة غير موجودة', ru: 'Страница не найдена' },
  notfound_text: {
    he: 'הכתובת שביקשתם אינה קיימת. ייתכן שהקישור שגוי או שהדף הוסר.',
    en: 'The address you requested does not exist. The link may be wrong, or the page was removed.',
    ar: 'العنوان الذي طلبته غير موجود. قد يكون الرابط خاطئًا أو أن الصفحة أُزيلت.',
    ru: 'Запрошенный адрес не существует. Возможно, ссылка неверна или страница была удалена.',
  },
